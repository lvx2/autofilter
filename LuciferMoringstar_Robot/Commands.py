    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**First join our channel 😅 👇 and try again!**",
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🔰 GROUP 🔰', url='https://t.me/Request_flix')
                    ]
                    ]
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                ...
                InlineKeyboardButton("🔰SERIES 🔰", url='https://t.me/joinchat/5T5yvugUmM9mN2Q1')
                ],[
